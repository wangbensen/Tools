...
public class UpdateByPrimaryKeyWithBLOBsElementExtendGenerated extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        attributes.clear();
        attributes.add(new Attribute("id", introspectedTable.getUpdateByPrimaryKeyWithBLOBsStatementId()));
        //重新生成element
